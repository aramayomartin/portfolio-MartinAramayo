    ...
    return (
        <Container id='about-me-section' className={`px-5 pt-5 ${style.aboutMe}`}>
            ...
            <p>
                ...
                realizando sus primeros pasos en el mundo IT. A lo largo de mi formación como ingeniero he desarrollado un pensamiento logico que me 
                permite solucionar problemas encontrando soluciones rapidas y eficientes. 
                <br/>
                Mi historia
                con la programación comienza a temprana edad mientras estudiaba en la Escuela de Educación
                Técnica 3138 - "Alberto Einstein" en Salta donde programabamos microcontroladores usando
                lenguaje Assembler. Posteriormente durante la carrera de grado he tenido la oportunidad de
                realizar diversos trabajos en lenguajes como C, C++, Python (Jupyter Notebooks) y tambien 
                realizado cálculos numericos con lenguajes orientados como MatLab, 
                ...
                ciudadano del mundo explotando el concepto de nomada digital.
                <br/>
